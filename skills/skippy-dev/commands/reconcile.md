...
<execution_context>
@~/.config/pai/Skills/skippy-dev/SKILL.md
@~/.config/pai/Skills/skippy-dev/references/reconciliation.md
@~/.config/pai/Skills/skippy-dev/references/state-consistency.md
</execution_context>
