...
- **[ERROR_CATALOG.md](references/ERROR_CATALOG.md)** - Complete list of error types with examples
- **[FALSE_POSITIVES.md](references/FALSE_POSITIVES.md)** - When warnings are acceptable
