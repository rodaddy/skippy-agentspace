...
6. **Tools-First Philosophy** - Deterministic work in executable code, AI for invocation (MANDATORY as of 2025-12-29)
...
├── workflows/ OR assets/
│   └── *.md
└── tools/ (if deterministic work needed)
    └── *.ts (executable scripts)
```
...
├── workflows/
│   └── *.md (flat or nested)
├── tools/ (RECOMMENDED - most skills benefit from executable tools)
│   ├── tool1.ts
│   └── tool2.ts
...
├── references/
├── state/
└── tools/ (REQUIRED - complex skills always have deterministic work)
    ├── core/
    │   └── *.ts
    └── helpers/
        └── *.ts
...
**ALWAYS read these canonical documents before creating:**
...
- Current best practices (code-first for deterministic work)
- Proven routing patterns
- Quality standards
- Proper use of executable tools vs markdown workflows
...
- [ ] tools/ directory (if skill has deterministic work)

**Tools-First Compliance (MANDATORY as of 2025-12-29):**
- [ ] Read TOOLS-FIRST.md before creating skill
- [ ] Identified deterministic work (3+ steps, data parsing, formatted output)
- [ ] Created executable tools for deterministic work
- [ ] Tools have shebang and are executable (chmod +x)
- [ ] Tools provide --help usage information
- [ ] Tools handle errors gracefully
- [ ] Workflows reference tools, not manual bash commands
- [ ] Validated against TOOLS-FIRST.md checklist
...
- [ ] Tool documentation included (if tools/ exists)
...
- [ ] Validated against TOOLS-FIRST.md (if applicable)
...
**~/.config/pai/Skills/system-createskill/TOOLS-FIRST.md** (MANDATORY as of 2025-12-29)
- Tools-first philosophy for deterministic work
- When to build executable tools vs markdown workflows
- Tool requirements and structure
- Implementation checklist
- Reference implementation: HistoryQuery skill
- Anti-patterns to avoid
- **ALWAYS read this before creating skills with deterministic work**
