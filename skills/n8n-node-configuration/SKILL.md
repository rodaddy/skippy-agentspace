...
- **[references/DEPENDENCIES.md](references/DEPENDENCIES.md)** - Property dependencies and displayOptions
- **[references/OPERATION_PATTERNS.md](references/OPERATION_PATTERNS.md)** - Configuration patterns by node type
- **[references/BEST_PRACTICES.md](references/BEST_PRACTICES.md)** - Do's, don'ts, configuration strategy, related skills
