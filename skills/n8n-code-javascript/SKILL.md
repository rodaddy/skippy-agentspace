...
**See**: [ERROR_PATTERNS.md](references/ERROR_PATTERNS.md) #3 for detailed error solutions
...
**See**: [COMMON_PATTERNS.md](references/COMMON_PATTERNS.md) for 10 detailed production patterns
...
**See**: [BUILTIN_FUNCTIONS.md](references/BUILTIN_FUNCTIONS.md) for complete reference
...
- [COMMON_PATTERNS.md](references/COMMON_PATTERNS.md) - 10 production-tested patterns
- [ERROR_PATTERNS.md](references/ERROR_PATTERNS.md) - Top 5 errors and solutions
- [BUILTIN_FUNCTIONS.md](references/BUILTIN_FUNCTIONS.md) - Complete built-in reference
