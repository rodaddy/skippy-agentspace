...
- **Does it have deterministic work?** (3+ steps, data parsing, bash pipelines) → Build tools/
...
├── SKILL.md
└── tools/            # RECOMMENDED if skill has deterministic work
    └── *.ts
...
├── tools/            # REQUIRED for most complex skills
│   ├── tool1.ts
│   └── tool2.ts
└── [subdirectories]/ # Supporting resources
```

**Tools-First Philosophy (MANDATORY as of 2025-12-29):**
- If skill has 3+ step workflows, precise bash commands, or data parsing → Build executable tools
- Tools do deterministic work, AI just invokes them
- Reference: `~/.config/pai/Skills/system-createskill/TOOLS-FIRST.md`
- Example implementation: `~/.config/pai/Skills/HistoryQuery/tools/`
...
**MANDATORY Reading (as of 2025-12-29):**
- `~/.config/pai/Skills/system-createskill/TOOLS-FIRST.md` - Tools-first philosophy and implementation guide

**Additional Resources:**
- `${PAI_DIR}/skills/create-skill/CLAUDE.md` - Complete guide with examples
- `${PAI_DIR}/skills/create-skill/templates/` - Skill templates
- `~/.config/pai/Skills/HistoryQuery/` - Reference implementation of tools-first pattern

## Key Principles

1. **Tools-First Philosophy** (MANDATORY as of 2025-12-29): Deterministic work in executable code, AI for invocation
2. **Progressive disclosure**: SKILL.md = quick reference, CLAUDE.md = deep dive
